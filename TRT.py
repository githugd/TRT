...
def cek_apk(session,coki):
	w=session.get("https://www.facebook.com/zulma.ayala.56?tab=active",cookies={"cookie":coki}).text
	...
	w=session.get("https://www.facebook.com/zulma.ayala.56/?tab=inactive",cookies={"cookie":coki}).text
	sop = BeautifulSoup(w,"html.parser")
	x = sop.find("form",method="post")
	game = [i.text for i in x.find_all("h3")]
	if len(game)==0:
